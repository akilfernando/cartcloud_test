...
export default function AdminNav({ page }: { page: string }) {
  return (
    <div className="absolute left-1/2 transform -translate-x-1/2 hidden md:block">
      <NavigationMenu>
        <NavigationMenuList className="flex space-x-8">
          <NavigationMenuItem>
            <Link to="/home" className={`text-gray-700 hover:text-gray-900 font-medium transition-colors pb-2 border-b-2 ${page === "profile" ? "text-gray-900 font-semibold border-gray-800" : "border-transparent hover:border-gray-300"}`}>Dashboard</Link>
          </NavigationMenuItem>
          <NavigationMenuItem>
